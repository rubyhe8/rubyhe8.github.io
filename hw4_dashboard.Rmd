...
### Bar Chart Evaluating Which Departments have the most frequent reorders
...
### scatter plot to see what days of the week items from the ice cream ice aisle is ordered 
...
instacart |> 
  ...
  layout(
    title = "Trend of Ice Cream Purchases by Day of Week",
    xaxis = list(title = "Day of Week"),
    yaxis = list(title = "Number of Orders")
  )
```

### in a random sample of 100 observations in the instacart dataset, boxplot of the distribution of 
...
instacart |> 
  ...
  layout(
    title = "Add-to-Cart Order by Time Since Prior Order (Sample of 100)",
